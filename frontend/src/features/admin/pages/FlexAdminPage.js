...
export default function FlexAdminPage() {
  ...
  return <main className="admin-flex-page"><div className="admin-flex-shell">
    <header className="admin-flex-header"><div><span>TRIP ADD-ONS</span><h1>Flex Assist Requests</h1><p>Review eligible change requests, find alternatives, obtain customer approval, and track rebooking completion.</p></div><nav><a href="/admin/baggage">Baggage Requests</a><a href="/admin/backoffice">Admin Home</a></nav></header>
