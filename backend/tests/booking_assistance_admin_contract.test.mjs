...
assert.match(contactStep, /Additional checked baggage/);
assert.match(contactStep, /additionalBaggageCount/);
assert.match(contactStep, /No baggage fee is charged during this booking/);
assert.match(contactStep, /pay for the approved baggage after booking/);
...
assert.match(assistanceService, /additionalBaggageCount/);
...
assert.match(adminController, /additionalBaggageCount/);
...
assert.match(adminPanel, /confirm availability and airline fee after booking/);
...
console.log('booking assistance + baggage persistence + admin operations + professional typography contract: PASS');
