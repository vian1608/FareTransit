...
import { nmiVaultRouter } from '../modules/secure-payments/nmi-vault.routes.mjs';
...
router.use('/secure-payments/nmi-vault', noStore, securePaymentRateLimiter, nmiVaultRouter);
